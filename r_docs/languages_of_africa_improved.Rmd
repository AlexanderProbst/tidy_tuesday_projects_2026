...
**Key Finding**: `r nrow(cross_border)` languages (`r cross_border_pct`% of all languages) are spoken across multiple countries. Arabic tops the list, spanning `r max(cross_border$countries)` nations, followed by Fulani (10 countries) and Mooré (8 countries). These languages facilitate regional communication and trade.
